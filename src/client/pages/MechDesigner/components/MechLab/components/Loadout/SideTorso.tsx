...
interface ISideTorsoProps extends ICommonProps {
  ...
  public render() {
    ...
    return (
      ...
      >
        ...
        { mech.tech === Tech.Clan
          ? <Detail label='CASE Protected' value={ <BooleanInput name={`loadout.${sideTorso.name}.caseProtected`} /> } color={DetailColor.TransparentBluishGrey} />
          : null }
      </Card>
    )
  }
