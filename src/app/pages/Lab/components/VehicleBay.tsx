      ...
      <div className='VehicleBay'>
        ...
        <div className='Column'>
          ...
          <InternalStructureConfiguration
            internalStructureChoices={Object.values(InternalStructure) as InternalStructure[]}
            internalStructure={InternalStructure.Standard}
            setHoverContext={setHoverContext}
          ...
          <ArmorTypeConfiguration
            armorTypeChoices={Object.values(Armor) as Armor[]}
            armorType={Armor.Standard}
            setHoverContext={setHoverContext}
