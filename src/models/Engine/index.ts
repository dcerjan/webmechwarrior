...
export const getAvailableEngines = (tech: TechType) => {
  switch (tech) {
  case TechType.Clan: return [EngineType.Standard, EngineType.ExtraLightClan]
  case TechType.InnerSphere: return [EngineType.Standard, EngineType.Compact, EngineType.Light, EngineType.ExtraLightIS]
  default: return []
  }
}
...
export const getEngineCriticalSlotAllocation = (type: EngineType): IEngineCriticalSlotAllocation => {
  ...
  case EngineType.Light: return { [MechComponentType.CenterTorso]: 6, [MechComponentType.LeftTorso]: 3, [MechComponentType.RightTorso]: 3 }
  case EngineType.ExtraLightIS: return { [MechComponentType.CenterTorso]: 6, [MechComponentType.LeftTorso]: 3, [MechComponentType.RightTorso]: 3 }
  case EngineType.ExtraLightClan: return { [MechComponentType.CenterTorso]: 6, [MechComponentType.LeftTorso]: 2, [MechComponentType.RightTorso]: 2 }
